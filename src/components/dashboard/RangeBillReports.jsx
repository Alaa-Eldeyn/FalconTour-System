...
function RangeBillReports() {
  ...
  const onSubmit = (data) => {
    ...
    axios
      ...
      .catch((error) => {
        if (
          error.response.data.message === "The to must be a date after from."
        ) {
    ...
    <div className="bg-gray-300 p-9 rounded-xl">
      <div className="w-full mb-5">
        <Link
          ...
          to="/dashboard/bill_summary/daily_bill_reports"
        >
      ...
      <>
        ...
        {/* bill summary  */}
        <h2 className="text-center w-full text-white p-2 bg-slate-500 mt-5">
...
export default RangeBillReports;
